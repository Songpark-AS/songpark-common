(ns songpark.common.impl.mqtt.client
  (:require #? (:clj [clojurewerkz.machine-head.client :as mh])
               [taoensso.timbre :as log]
               [songpark.common.protocol.mqtt.client :as protocol.mqtt.client]))

;; Implementation of mqtt protocol for clojure and web (not RN)
;; Expects a config of the form:
;; {:config {:scheme "tcp"
;;           :host "127.0.0.1"
;;           :port 1883
;;           :client-id "client-id" ;; should be autogenerated
