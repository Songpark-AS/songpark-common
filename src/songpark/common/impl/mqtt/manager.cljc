(ns songpark.common.impl.mqtt.manager
  (:require [com.stuartsierra.component :as component]
            ...
            [songpark.common.impl.mqtt.client :as mqtt.client]
            [songpark.common.impl.message.service :refer [handle-message]])
...
(defn- subscribe* [{:keys [client] :as mqtt-manager} topics]
  #? (:clj (letfn [(on-message [^String topic _ ^bytes payload]            
